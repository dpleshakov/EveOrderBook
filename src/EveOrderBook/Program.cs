namespace EveOrderBook
{
    internal class Program
    {
        ...
        private static void WriteHelpToConsole(string configPath, Taxes taxes, string stationId, string marketlogsPath) {
            Console.WriteLine($@"
...
Use 'Export to File' button in game to view a deal profit margin...");
        }
    }
}
